...
namespace Player
	...
	public class IsOnWalkableSlopeCondition : Condition
	{
		...
		protected override bool Statement() => _playerController.CanWalkOnSlope && (_playerController.IsCompletelyOnSlope || _playerController.SlopeInFront || _playerController.SlopeInBack) && !(_playerController.SlopeTag == "SpeedRamp");
	}
}